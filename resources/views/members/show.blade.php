...
@endpush
    ...
    <div class="col-md-4 currenttask">
                {!! Form::model($member, [
               'method' => 'PATCH',
                'url' => ['member/updateassign', $member->id],
                ]) !!}
                {!! Form::select('user_assigned_id', $users, $member->user->id, ['class' => 'form-control ui search selection top right pointing search-select', 'id' => 'search-select']) !!}
